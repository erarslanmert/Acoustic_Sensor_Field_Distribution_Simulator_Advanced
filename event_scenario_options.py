...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(298, 217)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(-115, 170, 341, 32))
        ...
        self.buttonBox.accepted.connect(self.openEventOptions)
    ...
    def openEventOptions(self):
        if self.radioButton.isChecked() == True:
            mainWindow.event_option_signal = 1
            mainWindow.event_file_name = str(self.lineEdit.text())
        elif self.radioButton_3.isChecked() == True:
            mainWindow.event_option_signal = 2
        else:
            mainWindow.event_option_signal = 0
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton.setText(_translate("Dialog", "Create custom event"))
        self.radioButton_3.setText(_translate("Dialog","Import from directory"))
        self.label_2.setText(_translate("Dialog","Enter Event Name:"))
